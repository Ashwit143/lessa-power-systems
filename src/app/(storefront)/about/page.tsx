        ...
        <div className="container-site py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-neutral-600 leading-relaxed mb-4">
              {SITE_CONFIG.businessName} was founded in {SITE_CONFIG.established} with a straightforward goal: give Hyderabad access to reliable power backup without the risk of counterfeit products. Over the years, we built a strong partnership with Luminous Power Technologies, becoming one of the city&apos;s authorized channel partners for their full range of inverters, batteries, and solar systems.
            </p>
            <p className="text-neutral-600 leading-relaxed">
              Every product we sell comes directly through Luminous&apos;s authorized supply chain, ensuring 100% genuine equipment backed by full manufacturer warranties. From honest technical advice to real after-sales support and AMC services, our commitment to quality is what has kept customers trusting us for over a decade.
            </p>
          </div>
        </div>
      </section>
